...
Trong cấu hình tốt nhất được ghi nhận, mô hình ANN với kiến trúc $784 \rightarrow 128 \rightarrow 10$ đạt train accuracy $96.78\%$ và dev accuracy $95.75\%$ tại iteration $490$. Do đó, confusion matrix được sử dụng để làm rõ hơn chất lượng của mô hình trên từng chữ số và chỉ ra các dạng lỗi còn tồn tại sau khi mô hình đã hội tụ tốt.
...
Kết quả thực nghiệm cho thấy mô hình ANN Fully Connected đã học được các đặc trưng pixel đủ mạnh để đạt train accuracy $96.78\%$ và dev accuracy $95.75\%$ tại iteration $490$ trong cấu hình tốt nhất. Điều này chứng tỏ mô hình có khả năng phân biệt phần lớn chữ số MNIST dù chỉ sử dụng một tầng ẩn với $128$ neuron.
...
Cấu hình được chọn là mô hình Fully Connected với kiến trúc $784 \rightarrow 128 \rightarrow 10$, hidden size $128$, learning rate $\alpha = 0.5$ và $500$ iterations. Kết quả cuối cùng được ghi nhận tại iteration $490$ là train accuracy $96.78\%$, dev accuracy $95.75\%$, train loss $0.1177$ và dev loss $0.1447$.
...
Kết quả thực nghiệm cho thấy mô hình hội tụ ổn định. Ở cấu hình tốt nhất $\alpha = 0.5$, train loss và dev loss đều giảm về mức thấp, trong khi train accuracy và dev accuracy lần lượt đạt $96.78\%$ và $95.75\%$. Khoảng cách nhỏ giữa hai accuracy cho thấy mô hình không bị overfitting nghiêm trọng ở cấu hình cuối cùng.
...
Với cấu hình tốt nhất trong báo cáo, mô hình đạt train accuracy $96.78\%$ và dev accuracy $95.75\%$ tại iteration $490$. Train loss đạt $0.1177$, dev loss đạt $0.1447$. Sự tương đồng tương đối giữa train loss và dev loss cho thấy quá trình tối ưu ổn định và mô hình có khả năng tổng quát hóa tốt trên tập dev.
...
| 0.5 | 128 | 500 | 0.1177 | 0.1447 | 96.78% | 95.75% | Cấu hình tốt nhất trong ba lần thử learning rate. |
